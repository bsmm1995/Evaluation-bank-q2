...
VALUES (2, 1, 'Retail', 1);
INSERT INTO tribe (id_tribe, id_organization, name, status)
VALUES (3, 1, 'Canales', 1);
INSERT INTO tribe (id_tribe, id_organization, name, status)
VALUES (4, 1, 'Tecnología Informática', 1);

INSERT INTO repository (id_repository, id_tribe, name, state, status, create_time)
VALUES (1, 1, 'cd-common-utils', 'E', 1, '2022-11-01');
INSERT INTO repository (id_repository, id_tribe, name, state, status, create_time)
VALUES (2, 1, 'cd-common-text', 'E', 1, '2022-10-01');
INSERT INTO repository (id_repository, id_tribe, name, state, status, create_time)
VALUES (3, 1, 'cd-common-log', 'E', 1, '2022-09-01');
INSERT INTO repository (id_repository, id_tribe, name, state, status, create_time)
...
UPDATE GEN
SET NEXT_VAL = 59
WHERE SEQUENCE_NAME = 'metrics';

UPDATE GEN
SET NEXT_VAL = 50
WHERE SEQUENCE_NAME = 'organization';

UPDATE GEN
SET NEXT_VAL = 53
WHERE SEQUENCE_NAME = 'tribe';
